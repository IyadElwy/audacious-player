            ...
            return RenderResultListAction(
                [
                    ExtensionResultItem(
                        ...
                        name="Audacious not installed or not playing",
                ...
                return RenderResultListAction(
                    [
                        ExtensionResultItem(
                            ...
                            name="Not found",
                            description="Can't find a music with that name in your playlist.",
                            on_enter=extension.render_main_page(),
                        )
                    ]
                )
            for song in songs:
                items.append(
                    ExtensionResultItem(
                        ...
                        name=song["name"],
                        description="Press enter to play this song",
                        on_enter=ExtensionCustomAction(
                            {"action": "jump", "pos": song["pos"]}
                        ),
                    )
                )
